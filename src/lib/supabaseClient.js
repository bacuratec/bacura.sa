...
if (!supabaseUrl || !supabaseAnonKey) {
  ...
  console.warn(
    "Supabase URL or anon key is missing. Please set NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY (or VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY for backward compatibility)."
  );
}
