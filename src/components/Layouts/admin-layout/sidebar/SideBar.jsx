...
const SideBar = ({ data }) => {
  ...
  return (
    <aside ref={containerRef} className={`h-screen overflow-hidden fixed ${collapsed ? "w-[88px]" : "w-[260px]"} bg-white border-r border-gray-200 top-0 right-0 hidden lg:flex flex-col justify-between shadow-sm z-50 select-none`}>
      <div ref={headerRef} className="logo p-4 flex items-center justify-between border-b border-gray-200 bg-white">
      ...
      <nav ref={scrollRef} className="flex-1 overflow-y-auto py-6 sidebar-scroll select-none" style={navHeight ? { height: navHeight } : undefined}>
