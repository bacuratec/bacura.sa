...
const ServiceCard = ({ icon, title, description, index }) => {
  return (
    <div
      title={description}
      className="relative h-auto min-h-auto lg:h-[226px] rounded-[20px] sm:rounded-[30px] bg-[#F8F8F8] transition-all duration-300 hover:bg-primary hover:text-white cursor-pointer group p-4 sm:p-6 flex flex-col justify-between"
    >
      {/* رقم الخدمة */}
